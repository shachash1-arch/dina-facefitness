...
const VIDEO_URL = "https://player.mediadelivery.net/embed/594735/ee429d6d-000b-4f94-8d1a-f172786f37d2";
...
const BokalCoursePage = () => {
  ...
  // קורא פרמטר מהלינק [?user=email@gmail.com](mailto:?user=email@gmail.com)
  useEffect(() => {
    const urlParams = new URLSearchParams(window.location.hash.split('?')[1] || '');
    const userEmail = urlParams.get('user');
    if (userEmail) {
      setEmail(userEmail);
      // סימולציה - בדיקה פשוטה
  ...
  const handleLogin = () => {
    // סימולציה - כל מייל תקף + סיסמה = כניסה
          ...
          <div className="container mx-auto px-6 py-20 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-green-50/80 p-12 rounded-3xl border-4 border-green-200">
                ...
                {/* הסרטון של Bunny.net */}
                <div className="video-player aspect-video bg-gray-200 rounded-2xl overflow-hidden">
                  <iframe
                    src={VIDEO_URL}
                    width="100%"
                    height="500"
